...
新建一个矩形区图层
```
public int saveLayerXxx(RectF bounds, Paint paint, int saveFlags)  
public int saveLayerXxx(float left, float top, float right, float bottom,Paint paint, int saveFlags)
```
